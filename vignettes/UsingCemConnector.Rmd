...
This is simply how commonly a co-occurence has been observed in the OHDSI network.
...
Consequently, it may be desirable to explore `siblings` of the related concept, using the concept ancestory.
...
```
Here we see a number of relationship definitions that relate the two concept sets, including PubMed literatrue (via mesh terms)
